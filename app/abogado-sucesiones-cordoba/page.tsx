...
export const metadata: Metadata = {
  title: 'Abogados Especialistas en Sucesiones en Córdoba | AUGUSTO Filí & Asociados',
  description: 'Más de 20 años resolviendo sucesiones. Te acompañamos de principio a fin. Tramitamos más de 50 casos por año.',
};

export default function AbogadoSucesionesCordoba() {
  return (
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-24 items-center">
              ...
              <div className="text-center lg:text-left order-2 lg:order-1">
                ...
                <p className="text-md sm:text-base md:text-lg lg:text-xl text-gray-600 font-medium mb-6 sm:mb-8 md:mb-10 max-w-xl mx-auto lg:mx-0">
                  Más de 20 años resolviendo sucesiones. <span className="font-black text-gray-900">Te acompañamos de principio a fin.</span> Tramitamos más de 50 casos por año.
                </p>

                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-2xl mx-auto lg:mx-0">
                  <WhatsAppLink
                    message="Hola, quiero una consulta sobre sucesiones"
              ...
              <div className="relative flex flex-col items-center justify-center order-1 lg:order-2">
                <div className="relative w-full aspect-[4/4] rounded-xl sm:rounded-2xl overflow-hidden shadow-xl sm:shadow-2xl">
                  <Image
                    src={HeroImage}
                    alt="Abogados de Sucesiones en Córdoba"
                    fill
